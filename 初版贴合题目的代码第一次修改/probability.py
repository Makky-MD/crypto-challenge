...
def Decision(Round, Probability, MatsuiRoundIndex, MatsuiCount, flag):
    ...
    CipherFour_Sbox = [[[0, 9, 9, 0, 9, 9, 9, 9, 1, 9], [9, 9, 9, 9, 9, 9, 0, 0, 1, 9], [9, 9, 9, 0, 9, 9, 9, 0, 1, 9],
    ...
    # Call solver cadical
    order = "./cadical " + "Problem-Round" + str(Round) + "-Probability" + str(Probability) + ".cnf > Round" + str(Round) + "-Probability" + str(Probability) + "-solution.out"
    os.system(order)
